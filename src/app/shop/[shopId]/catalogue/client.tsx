            ...
            <div className="max-w-7xl mx-auto p-4 md:p-8 space-y-6">
                ...
                <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
                    ...
                    <TabsContent value="settings" className="focus-visible:outline-none">
                        <Card className="max-w-3xl mx-auto border border-border shadow-sm bg-card overflow-hidden">
                            <CardHeader className="border-b border-gray-100 dark:border-gray-800 bg-muted/30 text-center p-6 md:p-8">
                                <div className="inline-flex items-center justify-center p-3 rounded-xl bg-gradient-to-br from-amber-100 to-amber-50 dark:from-amber-900/40 dark:to-amber-900/10 mx-auto mb-3">
                                    <Settings className="h-6 w-6 text-[#D4AF37]" />
                                </div>
                                <CardTitle className="text-xl md:text-2xl font-bold">Store Configuration</CardTitle>
                                <CardDescription>Update your store details and appearance</CardDescription>
                            </CardHeader>

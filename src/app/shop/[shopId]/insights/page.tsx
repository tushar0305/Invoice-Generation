...
import { startOfMonth, endOfMonth, subMonths, startOfDay, subDays, isWithinInterval, format } from 'date-fns';
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                const mappedInvoices = (invData || []).map((r: any) => ({
                    ...
                    userId: r.user_id,
                    shopId: r.shop_id,
                    createdBy: r.user_id, // Use user_id instead of non-existent created_by
                                    ...
                                    <div key={i} className="flex items-center gap-4 p-3 rounded-xl hover:bg-white/5 transition-colors group">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="flex justify-between text-xs text-muted-foreground">
                                                ...
                                                {/* <span className={cn(
                                                    product.growth.startsWith('+') ? "text-emerald-400" : "text-red-400"
                                                )}>{product.growth}</span> */}
                                            </div>

  ...
  return (
    <>
      <style jsx global>{`
        ...
        .summary-row.grand-total { font-size: 16px; font-weight: 700; background-color: #f9fafb; color: #800000; border-top: 2px solid #D4AF37; padding: 10px; border-radius: 0 0 4px 4px; }

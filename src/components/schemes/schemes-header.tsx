...
export const SchemesHeader = ({ shopName, stats, onAddNew }: SchemesHeaderProps) => (
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full md:w-auto">
                        ...
                        <div className="hidden md:flex gap-6 mr-4 border-r border-border/50 pr-6">
                            <div>
                                <p className="text-xs text-muted-foreground uppercase font-semibold tracking-wider">Enrollments</p>
                                <p className="text-2xl font-bold text-foreground">{stats.totalEnrollments}</p>
                            </div>
                            <div>
                                <p className="text-xs text-muted-foreground uppercase font-semibold tracking-wider">Collection</p>

                ...
                >
                    {plans.map((plan, index) => (
                        <motion.article
                            ...
                            className={`relative p-6 md:p-8 rounded-2xl border flex flex-col text-center ${
                                plan.popular
                        ...
                        >
                            ...
                            <Button
                                ...
                                className={`w-full min-h-[48px] text-base font-semibold transition-all focus-visible:ring-2 focus-visible:ring-gold-500 focus-visible:ring-offset-2 ${
                                    plan.popular

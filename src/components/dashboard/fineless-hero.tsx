...
export function FinelessHero({
    ...
    return (
        <motion.div
            ...
            className="relative overflow-hidden rounded-xl border border-border bg-card shadow-xl hover:shadow-primary/5 transition-all duration-500 group p-6"
        >
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-8">
                ...
                {catalogueStats && (
                    <div className="flex flex-col justify-center space-y-4 border-t md:border-t-0 md:border-l border-border md:pl-8 pt-4 md:pt-0">
                        <div className="flex items-center justify-between mb-2">
                            <h3 className="text-sm font-semibold text-primary uppercase tracking-wider">Digital Storefront</h3>

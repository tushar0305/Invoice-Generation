-- ==========================================
-- Migration: Add Role Helper Functions & Enforce Checks
-- Description: RISK-003 - Helper functions for RBAC and applying them to RPCs
-- Date: 2025-12-15
-- ==========================================

-- 1. Helper Function: is_shop_member
...
-- 2. Helper Function: is_shop_admin
...
-- 3. UPDATE create_invoice_v2 to check user has invoice creation permission
-- (Copying from migration 10 to ensure it's applied with helpers available)
...
BEGIN
    ...
    FOR v_item IN SELECT * FROM jsonb_array_elements(p_items) LOOP
        ...
        IF v_stock_id IS NOT NULL THEN
            -- Lock the row if it exists and is in stock
            ...
            -- If no row was found/locked, it's unavailable
            IF NOT FOUND THEN
...
-- 4. UPDATE soft_delete_invoice to require admin role
...
-- 5. UPDATE restore_invoice to require admin role
...
-- 6. UPDATE create_customer to check shop membership

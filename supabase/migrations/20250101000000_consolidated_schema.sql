...
-- User Shop Roles
DROP POLICY IF EXISTS "View shop roles" ON user_shop_roles;
CREATE POLICY "View shop roles" ON user_shop_roles
    FOR SELECT USING (user_id = auth.uid() OR is_shop_member(shop_id));

-- Customers
DROP POLICY IF EXISTS "View shop customers" ON customers;
CREATE POLICY "View shop customers" ON customers FOR SELECT USING (is_shop_member(shop_id));

DROP POLICY IF EXISTS "Manage shop customers" ON customers;
CREATE POLICY "Manage shop customers" ON customers FOR ALL USING (is_shop_member(shop_id));

-- Stock Items
DROP POLICY IF EXISTS "View shop stock" ON stock_items;
CREATE POLICY "View shop stock" ON stock_items FOR SELECT USING (is_shop_member(shop_id));

DROP POLICY IF EXISTS "Manage shop stock" ON stock_items;
CREATE POLICY "Manage shop stock" ON stock_items FOR ALL USING (is_shop_member(shop_id));

-- Invoices
DROP POLICY IF EXISTS "View shop invoices" ON invoices;
CREATE POLICY "View shop invoices" ON invoices FOR SELECT USING (is_shop_member(shop_id));

DROP POLICY IF EXISTS "Manage shop invoices" ON invoices;
CREATE POLICY "Manage shop invoices" ON invoices FOR ALL USING (is_shop_member(shop_id));
...
DROP POLICY IF EXISTS "Manage invoice items" ON invoice_items;
...
-- Ledger
DROP POLICY IF EXISTS "View shop ledger" ON ledger_transactions;
CREATE POLICY "View shop ledger" ON ledger_transactions FOR SELECT USING (is_shop_member(shop_id));

DROP POLICY IF EXISTS "Manage shop ledger" ON ledger_transactions;
CREATE POLICY "Manage shop ledger" ON ledger_transactions FOR ALL USING (is_shop_member(shop_id));

-- Staff Profiles
DROP POLICY IF EXISTS "View shop staff profiles" ON staff_profiles;
CREATE POLICY "View shop staff profiles" ON staff_profiles FOR SELECT USING (is_shop_member(shop_id));

DROP POLICY IF EXISTS "Manage shop staff profiles" ON staff_profiles;
CREATE POLICY "Manage shop staff profiles" ON staff_profiles FOR ALL USING (is_shop_owner(shop_id) OR is_shop_admin(shop_id));

-- Shop Invitations
DROP POLICY IF EXISTS "View shop invitations" ON shop_invitations;
CREATE POLICY "View shop invitations" ON shop_invitations FOR SELECT USING (is_shop_member(shop_id));

DROP POLICY IF EXISTS "Manage shop invitations" ON shop_invitations;
CREATE POLICY "Manage shop invitations" ON shop_invitations FOR ALL USING (is_shop_owner(shop_id));

-- Staff Payments
DROP POLICY IF EXISTS "View shop staff payments" ON staff_payments;
CREATE POLICY "View shop staff payments" ON staff_payments FOR SELECT USING (is_shop_member(shop_id));

DROP POLICY IF EXISTS "Manage shop staff payments" ON staff_payments;
CREATE POLICY "Manage shop staff payments" ON staff_payments FOR ALL USING (is_shop_owner(shop_id) OR is_shop_admin(shop_id));

-- Staff Attendance
DROP POLICY IF EXISTS "View shop staff attendance" ON staff_attendance;
CREATE POLICY "View shop staff attendance" ON staff_attendance FOR SELECT USING (is_shop_member(shop_id));

DROP POLICY IF EXISTS "Manage shop staff attendance" ON staff_attendance;
CREATE POLICY "Manage shop staff attendance" ON staff_attendance FOR ALL USING (is_shop_member(shop_id));

-- Market Rates
DROP POLICY IF EXISTS "Everyone can view market rates" ON market_rates;
CREATE POLICY "Everyone can view market rates" ON market_rates FOR SELECT USING (true);

DROP POLICY IF EXISTS "Authenticated users can update market rates" ON market_rates;
CREATE POLICY "Authenticated users can update market rates" ON market_rates FOR ALL USING (auth.role() = 'authenticated');

-- Loyalty
DROP POLICY IF EXISTS "View shop loyalty settings" ON shop_loyalty_settings;
CREATE POLICY "View shop loyalty settings" ON shop_loyalty_settings FOR SELECT USING (is_shop_member(shop_id));

DROP POLICY IF EXISTS "Manage shop loyalty settings" ON shop_loyalty_settings;
CREATE POLICY "Manage shop loyalty settings" ON shop_loyalty_settings FOR ALL USING (is_shop_admin(shop_id));
...
-- Catalogue
DROP POLICY IF EXISTS "Owners can manage catalogue settings" ON catalogue_settings;
CREATE POLICY "Owners can manage catalogue settings" ON catalogue_settings FOR ALL USING (public.is_shop_owner(shop_id));

DROP POLICY IF EXISTS "Public can view active settings" ON catalogue_settings;
CREATE POLICY "Public can view active settings" ON catalogue_settings FOR SELECT USING (is_active = true);

DROP POLICY IF EXISTS "Owners can manage categories" ON catalogue_categories;
CREATE POLICY "Owners can manage categories" ON catalogue_categories FOR ALL USING (public.is_shop_owner(shop_id));

DROP POLICY IF EXISTS "Public can view active categories" ON catalogue_categories;
CREATE POLICY "Public can view active categories" ON catalogue_categories FOR SELECT USING (is_active = true);

DROP POLICY IF EXISTS "Owners can manage products" ON catalogue_products;
CREATE POLICY "Owners can manage products" ON catalogue_products FOR ALL USING (public.is_shop_owner(shop_id));

DROP POLICY IF EXISTS "Public can view active products" ON catalogue_products;
CREATE POLICY "Public can view active products" ON catalogue_products FOR SELECT USING (is_active = true);
...
-- WhatsApp
DROP POLICY IF EXISTS "Shop members can view whatsapp config" ON whatsapp_configs;
CREATE POLICY "Shop members can view whatsapp config" ON whatsapp_configs FOR SELECT USING (is_shop_member(shop_id));

DROP POLICY IF EXISTS "Shop owners can manage whatsapp config" ON whatsapp_configs;
CREATE POLICY "Shop owners can manage whatsapp config" ON whatsapp_configs FOR ALL USING (is_shop_owner(shop_id));

DROP POLICY IF EXISTS "Shop members can view templates" ON whatsapp_templates;
CREATE POLICY "Shop members can view templates" ON whatsapp_templates FOR SELECT USING (is_shop_member(shop_id));

DROP POLICY IF EXISTS "Shop members can manage templates" ON whatsapp_templates;
CREATE POLICY "Shop members can manage templates" ON whatsapp_templates FOR ALL USING (is_shop_member(shop_id));

DROP POLICY IF EXISTS "Shop members can view messages" ON whatsapp_messages;
CREATE POLICY "Shop members can view messages" ON whatsapp_messages FOR SELECT USING (is_shop_member(shop_id));

DROP POLICY IF EXISTS "Shop members can send messages" ON whatsapp_messages;
CREATE POLICY "Shop members can send messages" ON whatsapp_messages FOR INSERT WITH CHECK (is_shop_member(shop_id));

-- Loans
DROP POLICY IF EXISTS "Users can view customers for their shop" ON loan_customers;
CREATE POLICY "Users can view customers for their shop" ON loan_customers FOR SELECT USING (is_shop_member(shop_id));

DROP POLICY IF EXISTS "Users can insert customers for their shop" ON loan_customers;
CREATE POLICY "Users can insert customers for their shop" ON loan_customers FOR INSERT WITH CHECK (is_shop_member(shop_id));

DROP POLICY IF EXISTS "Users can update customers for their shop" ON loan_customers;
CREATE POLICY "Users can update customers for their shop" ON loan_customers FOR UPDATE USING (is_shop_member(shop_id));

DROP POLICY IF EXISTS "Users can view loans for their shop" ON loans;
CREATE POLICY "Users can view loans for their shop" ON loans FOR SELECT USING (is_shop_member(shop_id));

DROP POLICY IF EXISTS "Users can insert loans for their shop" ON loans;
CREATE POLICY "Users can insert loans for their shop" ON loans FOR INSERT WITH CHECK (is_shop_member(shop_id));

DROP POLICY IF EXISTS "Users can update loans for their shop" ON loans;
CREATE POLICY "Users can update loans for their shop" ON loans FOR UPDATE USING (is_shop_member(shop_id));

DROP POLICY IF EXISTS "Users can view collateral for their shop loans" ON loan_collateral;
CREATE POLICY "Users can view collateral for their shop loans" ON loan_collateral FOR SELECT
USING (EXISTS (SELECT 1 FROM loans WHERE loans.id = loan_collateral.loan_id AND is_shop_member(loans.shop_id)));

DROP POLICY IF EXISTS "Users can insert collateral for their shop loans" ON loan_collateral;
CREATE POLICY "Users can insert collateral for their shop loans" ON loan_collateral FOR INSERT
WITH CHECK (EXISTS (SELECT 1 FROM loans WHERE loans.id = loan_collateral.loan_id AND is_shop_member(loans.shop_id)));

DROP POLICY IF EXISTS "Users can view payments for their shop loans" ON loan_payments;
CREATE POLICY "Users can view payments for their shop loans" ON loan_payments FOR SELECT
USING (EXISTS (SELECT 1 FROM loans WHERE loans.id = loan_payments.loan_id AND is_shop_member(loans.shop_id)));

DROP POLICY IF EXISTS "Users can insert payments for their shop loans" ON loan_payments;
CREATE POLICY "Users can insert payments for their shop loans" ON loan_payments FOR INSERT
WITH CHECK (EXISTS (SELECT 1 FROM loans WHERE loans.id = loan_payments.loan_id AND is_shop_member(loans.shop_id)));

-- Subscriptions
DROP POLICY IF EXISTS "Shop owners can view their subscription" ON subscriptions;
CREATE POLICY "Shop owners can view their subscription" ON subscriptions FOR SELECT USING (is_shop_admin(shop_id));

DROP POLICY IF EXISTS "Users can read subscription for limits" ON subscriptions;
CREATE POLICY "Users can read subscription for limits" ON subscriptions FOR SELECT USING (is_shop_member(shop_id));

-- Audit Logs
DROP POLICY IF EXISTS "Shop owners can view audit logs" ON audit_logs;
CREATE POLICY "Shop owners can view audit logs" ON audit_logs FOR SELECT USING (is_shop_admin(shop_id));

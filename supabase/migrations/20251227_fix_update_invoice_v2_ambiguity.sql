-- Fix ambiguous update_invoice_v2 RPC by dropping old definition
DROP FUNCTION IF EXISTS public.update_invoice_v2(uuid, uuid, jsonb, jsonb[]);

-- Recreate the correct definition
